  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await save({
        ...
        class: formData.class ? formData.class : "1",
        nik: formData.nik,
          ...
          <div className="rounded-xl border bg-white p-5 pb-16">
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-5">
              ...
              <div className="group relative z-0 mb-5 w-full">
                ...
                {formData.nik.length !== 16 && <p className="mt-2 text-xs text-red-500">NIK harus 16 karakter dan Sesuai dengan data nik pada KK</p>}
              </div>
              {/* <div className="group relative z-0 mb-5 w-full">
