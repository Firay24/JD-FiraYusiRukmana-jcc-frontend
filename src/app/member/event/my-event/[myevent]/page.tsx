        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          {detailActivity ? (
            <div className="grid grid-cols-1 gap-4">
              <div className="mt-5 flex flex-col gap-2 rounded-lg bg-white p-7 md:mt-0">
                <h2 className="text-lg font-medium">Informasi Kegiatan Lomba Peserta</h2>
            ...
            <div className="mt-2 rounded-xl bg-white p-7 md:mt-0">
              <SkeletonLoader rows={5} />
            </div>
          )}
        </div>
